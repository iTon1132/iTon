...
namespace NeptuneEvo
{
    ...
    { 
        public static string Codename { get; } = "iTon";
        ...
        public static void CMD_BUILD(Player client)
        {
            try
            {
                client.SendChatMessage($"Сборка сервера (by iTon) !{{#00FFFF}}{Full}!{{#FFF}} успешно запущена !{{#f39c12}}{StartDate}");
            }
            catch { }
        }
    ...
    public static class PasswordRestore
    {
        ...
        private static string mailFrom = config.TryGet<string>("From", "noreply@iton.com");
